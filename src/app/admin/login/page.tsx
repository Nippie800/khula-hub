...
export default function AdminLoginPage() {
  ...
  return (
    <main className="py-10">
      <Container>
        <div className="rounded-3xl border border-gray-200 p-6 shadow-sm max-w-xl">
          ...
          <div className="mt-6 grid gap-4">
            ...
            <TextField label="Password" name="password" value={password} onChange={setPassword} type="password" required />

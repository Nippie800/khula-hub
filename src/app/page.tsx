...
export default function HomePage() {
  return (
    <main>
      ...
      <section className="bg-gradient-to-br from-blue-900 via-teal-700 to-lime-400 py-16">
        <Container>
          ...
          <div className="grid gap-6 md:grid-cols-3">
            ...
            <Step n="2" title="EFT Payment" desc="Receive banking details and your unique payment reference." />
            <Step n="3" title="Confirmation" desc="Once payment is matched, Khula confirms your registration." />
          </div>
        </Container>
      </section>
        ...
        <Container>
          <div className="grid gap-8 lg:grid-cols-3">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:col-span-2">
              <FeatureCard title="Ownership mindset" desc="Learners practice responsibility and leadership." />
              <FeatureCard title="Truth builders" desc="Developing integrity and strong decision-making." />
              <FeatureCard title="Healthy community" desc="Friendship, accountability, and growth together." />
              <FeatureCard title="Practical growth" desc="Skills learners can use in real life." />
            </div>
          </div>
        </Container>
      </section>

      <section id="team" className="scroll-mt-24 bg-gray-50 py-16">
        <Container>
            ...
            <div className="rounded-3xl border border-gray-200 bg-white p-5 shadow-sm">
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-600">Content + Community</p>
                </div>
              </div>

              <p className="mt-4 text-sm text-gray-700">
                Leads camp marketing and manages social media, sharing moments
                that reflect Khula’s values.
              </p>
            </div>

        ...
        <div className="rounded-3xl border border-gray-200 p-6 shadow-sm">
          ...
          <div className="mt-6 rounded-2xl border border-gray-200 p-4">
            ...
            <div className="mt-3 grid gap-2 text-sm text-gray-800">
              <p>
                <b>Bank:</b> {EFT.bankName}
              </p>
              <p>
                <b>Account name:</b> {EFT.accountName}
              </p>
              <p>
                <b>Account number:</b> {EFT.accountNumber}
              </p>
              <p>
                <b>Branch code:</b> {EFT.branchCode}
              </p>
              <p>
                <b>Amount:</b> {EFT.amount}
              </p>
            </div>

            <p className="mt-4 text-sm text-gray-700">
              After payment, keep your proof of payment. (We can add a proof upload step next.)
            </p>
          </div>
